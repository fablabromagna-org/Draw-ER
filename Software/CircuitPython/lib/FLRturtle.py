...
# Pin assignments
emitter = digitalio.DigitalInOut(board.GP2)
leftLED = digitalio.DigitalInOut(board.GP3)
...
Lstep0 = digitalio.DigitalInOut(board.GP8)
Lstep1 = digitalio.DigitalInOut(board.GP9)
Lstep2 = digitalio.DigitalInOut(board.GP10)
Lstep3 = digitalio.DigitalInOut(board.GP11)

Rstep0 = digitalio.DigitalInOut(board.GP12)
Rstep1 = digitalio.DigitalInOut(board.GP13)
Rstep2 = digitalio.DigitalInOut(board.GP14)
Rstep3 = digitalio.DigitalInOut(board.GP15)
